...
const documents = [
  ...
  { _id: "item-losos", _type: "menuItem", name: "Śniadanie Łosoś", slug: slug("sniadanie-losos"), category: ref("cat-breakfast"), description: "chleb, jajecznica, awokado, łosoś, dżem, masło, sałatka", price: "39", isVisible: true, isAvailable: true, isFeatured: true, order: 2 },
  ...
  { _id: "item-citrus-coffee", _type: "menuItem", name: "Citrus Coffee", slug: slug("citrus-coffee"), category: ref("cat-coffee"), price: "27", isNew: true, isVisible: true, isAvailable: true, isFeatured: false, order: 2 },
  ...
  { _id: "item-ice-filter", _type: "menuItem", name: "Ice Filter", slug: slug("ice-filter"), category: ref("cat-coffee"), price: "19", isNew: true, isVisible: true, isAvailable: true, isFeatured: false, order: 4 },
  ...
  { _id: "item-tropical-matcha", _type: "menuItem", name: "Tropical Matcha", slug: slug("tropical-matcha"), category: ref("cat-matcha"), price: "28", isNew: true, isVisible: true, isAvailable: true, isFeatured: false, order: 1 },
  ...
  { _id: "item-ice-matcha-sesame", _type: "menuItem", name: "Ice Matcha Sesame", slug: slug("ice-matcha-sesame"), category: ref("cat-matcha"), price: "28", isNew: true, isVisible: true, isAvailable: true, isFeatured: false, order: 4 },
];
